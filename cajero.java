...
public class cajero extends EmpleadoAbstract {

    Double sueldoBase;
    Double sueldoDia = 200.00;
    int dias;
    Double porcentajeBono = 0.02;
    Double ventas;
    Double comision;
    Double porcentajeProd = 0.01;
    Double productividad;

    public cajero(int noEmpleado, String nombreEmpleado, String puesto, Double sueldoBase, Double sueldoDia,
     int dias, Double porcentajeBono, Double ventas, Double comision, Double porcentajeProd, Double productividad) {
